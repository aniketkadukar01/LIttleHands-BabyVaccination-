        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Childrens_ChildrenID",
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_VaccineTypes_VaccineId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "ContactNumber", "Email", "FirstName", "LastName", "Password", "Role" },
                values: new object[,]
                {
                    { 1, "1234567890", "john.doe@example.com", "John", "Doe", "password123", 1 },
                    { 2, "0987654321", "jane.smith@example.com", "Jane", "Smith", "password456", 0 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ChildrenID",
                table: "Appointments",
                column: "ChildrenID");
